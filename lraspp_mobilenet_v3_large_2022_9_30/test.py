...
class Test(object):
    ...
    def _init_logger(self):
        ...
        self.model_name = 'lraspp_mobilenet_v3_large'
        ...
        #self.model_load_path = 'logs/lraspp_mobilenet_v3_large/dust/train/20221023-003817/Checkpoints/Model_897_t1.pth'  #dataset_897
        self.model_load_path = 'logs/lraspp_mobilenet_v3_large/dust/train/20221023-122020/Checkpoints/Model_100_t1.pth'  #dataset_100
    ...
    def run(self):
        ...
        # build models
        model = M.segmentation.lraspp_mobilenet_v3_large(pretrained=False, progress=True, num_classes=1, aux_loss=None)
